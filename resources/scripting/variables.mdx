...
<Info>This section is only available for the `level message` command.</Info>
...
<Info>This section is only available for the `boost` command.</Info>
...
<Info>This section is only available for the `bumpreminder` command.</Info>
...
<Info>This section is only available for the `youtube message` command.</Info>
...
<Info>
Only available for `bandm`, `softbandm`, `kickdm`, `warndm`, `jaildm`, `unjaildm`, `timeoutdm`, `ban message`, `kick message`, and **moderation related** commands.
</Info>
